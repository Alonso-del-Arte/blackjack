...
public class RanOutOfCardsExceptionTest {
    ...
    /**
     * Another test of getRank method, of class RanOutOfCardsException. If the 
     * exception was constructed without specifying a rank deficiency, the 
     * getter should return a null pointer.
     */
    @Test
    ...
    /**
     * Another test of getSuit method, of class RanOutOfCardsException. If the 
     * exception was constructed without specifying a suit deficiency, the 
     * getter should return a null pointer.
     */
    @Test
